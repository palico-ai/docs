export const metadata = {
  title: "LLM Providers",
  description:
    "Learn how use different LLM models and providers with Palico AI.",
}

# Model Providers

With Palico, you own the implementation details of your LLM application. As such, you can use any LLM model provider to build your application. Here are some common LLM model providers that you can use with Palico.
...
For the most up-to-date information on how to call Anthropic via the Anthropic SDK, please refer to the [npm package docs](https://www.npmjs.com/package/@anthropic-ai/sdk).
