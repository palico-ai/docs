...
are the actions that the copilot can take. For Palico, tools are defined in the server-side agent and
implemented in the client-side app. Here's how you can add tools to your copilot.
